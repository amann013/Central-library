...
render(){
    return(
        ...
        <br/><br/><br/>
            <h6>
            The Central Library of NATIONAL INSTITUTE OF TECHNOLOGY JAMSHEDPUR is the heart of the institute providing direct academic and research supports to all departments.
